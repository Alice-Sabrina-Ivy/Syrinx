...
| Perceived gender | JaesungHuh ECAPA-TDNN q8 (`Alice-Sabrina-Ivy/voice-gender-classifier-onnx-q8`, ~15.4 M params, MIT), single model on all platforms. Backend: WASM (WebGPU dropped 2026-07-19 — 4.7× slower + broken); desktop ~52 ms/inference at ~6.2 Hz cadence. Re-quantized "v2" model (100/100 Hillenbrand, exclude-matmul recipe) staged at `build/jaesunghuh-gender-v2/`, pending HF upload + mobile WASM measurement | 2026-05-06; backend + cadence 2026-07-19 | [INVESTIGATIONS.md §gender](INVESTIGATIONS.md), [gender-model-latency-2026-07-19.md](measurements/gender-model-latency-2026-07-19.md) |
